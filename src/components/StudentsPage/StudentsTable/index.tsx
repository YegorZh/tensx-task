            ...
            <div className="StudentsTable__pages">
                <span className="StudentsTable__pages-rows-wrapper">
                    ...
                    <select
                        ...
                        onChange={(event) => dispatcher(setRowsPerPage(Number(event?.target.value)))}
                    >
                        {selectOptions}
                    </select>
                </span>
                ...
                <span className="StudentsTable__pages-change">
                    <button className="StudentsTable__pages-button-previous" onClick={() => dispatcher(pagePrevious())}>
                    ...
                    <button className="StudentsTable__pages-button-next" onClick={() => dispatcher(pageNext())}>
                        <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
